...
@section('style')
    ...
    <link rel="stylesheet" href="main/css/jvectormap/jquery-jvectormap-2.0.3.css">
...
@section('javascript')
    ...
    <script src="main/js/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="main/js/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="main/js/jvectormap/jvectormap-active.js"></script>
    ...
    <script src="main/js/flot/curvedLines.js"></script>
    ...
    <script src="main/js/chat/moment.min.js"></script>
                        ...
                        <div class="recent-post-items">
                                ...
                                <a href="#">
                                    <div class="recent-post-flex">
                                        <div class="recent-post-img">
                                            <img src="main/img/post/2.jpg" alt="" />
                                        </div>
                            ...
                            <div class="recent-post-signle">
                                <a href="#">
                                    <div class="recent-post-flex rct-pt-mg">
                                        <div class="recent-post-img">
                                            <img src="main/img/post/1.jpg" alt="" />
                                        </div>
                                        <div class="recent-post-it-ctn">
                                            <h2>John Deo</h2>
                                            <p>Nunc quis diam diamurabitur at dolor elementum, dictum turpis vel</p>
                            ...
                            <div class="recent-post-signle">
                                <a href="#">
                                    <div class="recent-post-flex rct-pt-mg">
                                        <div class="recent-post-img">
                                            <img src="main/img/post/4.jpg" alt="" />
                                        </div>
                                        <div class="recent-post-it-ctn">
                                            <h2>Malika</h2>
                                            <p>Nunc quis diam diamurabitur at dolor elementum, dictum turpis vel</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="realtime-wrap notika-shadow mg-t-30">
                        ...
                        <div class="realtime-country-ctn realtime-ltd-mg">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="main/img/country/1.png" alt="" /></span> <span>United States</span>
                                </div>
                        ...
                        <div class="realtime-country-ctn">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="main/img/country/2.png" alt="" /></span> <span>Australia</span>
                                </div>
                                <div class="realtime-bw">
                                    <span>Firefox</span>
                                </div>
                        ...
                        <div class="realtime-country-ctn">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="main/img/country/3.png" alt="" /></span> <span>Brazil</span>
                                </div>
                                <div class="realtime-bw">
                                    <span>Firefox</span>
                                </div>
                                    ...
                                    <ul class="conversation-list">
                                        <li class="clearfix">
                                            <div class="chat-avatar">
                                                <img src="main/img/post/1.jpg" alt="male">
                                                <i>10:00</i>
                                            </div>
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="main/img/post/2.jpg" alt="Female">
                                                <i>10:01</i>
                                            </div>
                                            <div class="conversation-text">
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="main/img/post/2.jpg" alt="male">
                                                <i>10:02</i>
                                            </div>
                                            <div class="conversation-text">
                                                <div class="ctext-wrap chat-widgets-cn">
